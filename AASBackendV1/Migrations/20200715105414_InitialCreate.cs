    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            columns: table => new
            {
                ...
                SourceUrl = table.Column<bool>(nullable: false),
                InputModel = table.Column<int>(nullable: false),
                OutputModel = table.Column<string>(nullable: true),
                IsPaid = table.Column<DateTime>(nullable: true),                
                Created = table.Column<DateTime>(nullable: false),
                Updated = table.Column<DateTime>(nullable: true)
            },
            constraints: table =>
            {
                table.PrimaryKey("PK_AASItems", x => x.Id);
            });
